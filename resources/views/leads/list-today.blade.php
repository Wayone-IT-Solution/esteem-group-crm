                ...
                <div class="col-md-9 text-md-end mt-3 mt-md-0">
                    <div class="d-flex flex-wrap justify-content-md-end gap-2">
                        ...
                        <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#importLeadsModal">
                                    ...
                                    <div class="d-flex justify-content-center gap-1">
                                        @if (!empty($lead->assinges))
                                            @foreach ($lead->assinges as $list)
                                                ...
                                                @endphp
                                                <div class="assigned-avatar" data-bs-toggle="tooltip"
                                                    title="{{ $user->name ?? 'N/A' }}">
                                                    {{ $initials }}
                                                </div>
                                            @endforeach
                                        @else
                                            <div class="assigned-avatar bg-secondary" data-bs-toggle="tooltip"
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        ...
                                        <button class="btn btn-sm btn-danger"
                                            onclick="CommanDelete('delete', 'lead_models', '{{ $lead->id }}')">
            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body p-4">
                    <div class="text-center mb-4">
                        <div class="rounded-circle bg-white mx-auto mb-3"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form action="{{ route('admin.leads.import') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="importLeadsModalLabel"><i class="fa-solid fa-file-import me-2"></i>Import
                        Leads</h5>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success" id="leadImportButton" onclick="changetext()"><i
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#userFilterForm').submit(function(e) {
                ...
                // If both dates are empty, use today's date
                if (!fromDate && !toDate) {
                ...
                $.ajax({
                    url: `{{ route('admin.leads.filterEnquires') }}`,
                    method: 'POST',
                    data: {
                        company_id,
                        search,
