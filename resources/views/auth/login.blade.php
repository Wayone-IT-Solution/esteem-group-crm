...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-xl-7 login_one_image"><img class="bg-img-cover bg-center" src="{{ asset('assets/images/crm.png') }}" alt="looginpage"></div>
      <div class="col-xl-5 p-0">
        <div class="login-card login-dark login-bg">
          <div>
            <div><a class="logo" href="javascript:void(0)"><img style="width: auto; height:60px;" class="img-fluid for-light" src="{{ asset('assets/images/logo.png')}}" alt="looginpage"><img class="for-dark m-auto" src="{{ asset('assets/images/logo.png') }}" alt="logo"></a></div>
            <div class="login-main">
              <form method="post" class="theme-form mb-5" id="loginform" action="{{ route('validate.login') }}">
                ...
                <div class="form-group mb-0 checkbox-checked">
                  <div class="form-check checkbox-solid-info">
                    ...
                    <div class="text-end mt-3"><button type="submit" id="loginbutton" class="btn btn-primary btn-block w-100 text-white" href="index.html">Sign in </button></div>
                  </div>
