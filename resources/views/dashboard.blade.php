                                                ...
                                                <table class="table" id="sell-product">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <div class="flex-shrink-0"><img class="img-30 b-r-10" src="{{ asset('assets/images/dashboard2/order/watch.png')}}" alt=""></div>
                                                                    <div class="flex-grow-1"> <a href="product.html">
                                                                            <h6 class="f-w-500">Mi Watch Revolve</h6><span class="font-light f-w-400 f-13">10 April 2024</span>
                                                                        </a></div>
                                                                </div>
                                                            </td>
                                                            <td>#787669</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <div class="flex-shrink-0"><img class="img-30 b-r-10" src="{{ asset('assets/images/dashboard2/order/flower.png')}}" alt=""></div>
                                                                    <div class="flex-grow-1"> <a href="product.html">
                                                                            <h6 class="f-w-500">Tree Stylish Pot</h6><span class="font-light f-w-400 f-13">16 June 2024</span>
                                                                        </a></div>
                                                                </div>
                                                            </td>
                                                            <td>#749U8F</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <div class="flex-shrink-0"><img class="img-30 b-r-10" src="{{ asset('assets/images/dashboard2/order/bench.png')}}" alt=""></div>
                                                                    <div class="flex-grow-1"> <a href="product.html">
                                                                            <h6 class="f-w-500">Wood Chair Dark</h6><span class="font-light f-w-400 f-13">23 May 2024</span>
                                                                        </a></div>
                                                                </div>
                                                            </td>
                                                            <td>#509478</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <div class="flex-shrink-0"><img class="img-30 b-r-10" src="{{ asset('assets/images/dashboard2/order/shoes.png')}}" alt=""></div>
                                                                    <div class="flex-grow-1"> <a href="product.html">
                                                                            <h6 class="f-w-500">Sneakers For Men</h6><span class="font-light f-w-400 f-13">12 April 2024</span>
                                                                        </a></div>
                                                                </div>
                                                            </td>
                                                            <td>#738445</td>
                                    ...
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex gap-2 align-items-center">
                                                        <div class="flex-shrink-0"> <img class="img-fluid img-42 b-r-10" src="{{ asset('assets/images/avatar/2.jpg')}}" alt=""></div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex gap-2 align-items-center">
                                                        <div class="flex-shrink-0"> <img class="img-fluid img-42 b-r-10" src="{{ asset('assets/images/avatar/5.jpg')}}" alt=""></div>
                                                        <div class="flex-grow-1"> <a href="user-profile.html">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex gap-2 align-items-center">
                                                        <div class="flex-shrink-0"> <img class="img-fluid img-42 b-r-10" src="{{ asset('assets/images/avatar/9.jpg')}}" alt=""></div>
                                                        <div class="flex-grow-1"> <a href="user-profile.html">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex gap-2 align-items-center">
                                                        <div class="flex-shrink-0"> <img class="img-fluid img-42 b-r-10" src="{{ asset('assets/images/avatar/8.jpg')}}" alt=""></div>
                                                        <div class="flex-grow-1"> <a href="user-profile.html">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex gap-2 align-items-center">
                                                        <div class="flex-shrink-0"> <img class="img-fluid img-42 b-r-10" src="{{ asset('assets/images/avatar/13.jpg')}}" alt=""></div>
                                                        <div class="flex-grow-1"> <a href="user-profile.html">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex gap-2 align-items-center">
                                                        <div class="flex-shrink-0"> <img class="img-fluid img-42 b-r-10" src="{{ asset('assets/images/avatar/7.jpg')}}" alt=""></div>
                                                        <div class="flex-grow-1"> <a href="user-profile.html">
                                    ...
                                    <div class="swiper mySwiper">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="item text-center"><img class="img-fluid" src="{{ asset('assets/images/dashboard2/headphone.png')}}" alt=""><img class="product-gif img-fluid" src="{{ asset('assets/images/gif/new.gif')}}" alt="">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="item text-center"><img class="img-fluid" src="{{ asset('assets/images/dashboard2/9.png')}}" alt=""><img class="product-gif img-fluid" src="{{ asset('assets/images/gif/new.gif')}}" alt="">
                                                    <div class="product-content">
                                                        <h4><a class="f-18" href="product.html">Wireless Apple Airpods</a></h4>
                                                        <h5 class="font-primary f-w-600 f-16 mt-1">$130.00</h5>
                                                    </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="item text-center"><img class="img-fluid" src="{{ asset('assets/images/dashboard2/7.png')}}" alt=""><img class="product-gif img-fluid" src="{{ asset('assets/images/gif/new.gif')}}" alt="">
                                                    <div class="product-content">
                                                        <h4><a class="f-18" href="product.html">Wireless Apple Airpods</a></h4>
                                                        <h5 class="font-primary f-w-600 f-16 mt-1">$130.00</h5>
                                                    </div>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img class="b-r-10" src="{{ asset('assets/images/avatar/6.jpg')}}" alt=""></div>
                                                            <div class="flex-grow-1"> <a href="user-profile.html">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img class="b-r-10" src="{{ asset('assets/images/user/8.jpg')}}" alt=""></div>
                                                            <div class="flex-grow-1"> <a href="user-profile.html">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img class="b-r-10" src="{{ asset('assets/images/user/15.jpg')}}" alt=""></div>
                                                            <div class="flex-grow-1"> <a href="user-profile.html">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img class="b-r-10" src="{{ asset('assets/images/user/14.jpg')}}" alt=""></div>
                                                            <div class="flex-grow-1"> <a href="user-profile.html">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img class="b-r-10" src="{{ asset('assets/images/avatar/9.jpg')}}" alt=""></div>
                                                            <div class="flex-grow-1"> <a href="user-profile.html">
