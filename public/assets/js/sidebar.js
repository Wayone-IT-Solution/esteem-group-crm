(function () {
    ...
    sidebarListItems.forEach((item) => {
        item.addEventListener("click", () => {
            ...
            sidebarListItems.forEach((otherItem) => {
                if (otherItem !== item) {
                    otherItem.classList.remove("active");
                    const otherSubmenu = otherItem
                        .closest(".sidebar-list")
                        .querySelector(".sidebar-submenu");
            ...
            // Toggle icon
            if (toggleIcon) {
                toggleIcon.classList.toggle("fa-angle-down", isActive);
                toggleIcon.classList.toggle("fa-angle-up", !isActive);
            }
        });
    });
    ...
    pinIcon.forEach((item, index) => {
        ...
        item.addEventListener("click", (event) => {
            ...
            setTimeout(() => {
                if (
                    item.parentElement.parentElement.classList.contains("pined")
                ) {
                    scrollTo(
